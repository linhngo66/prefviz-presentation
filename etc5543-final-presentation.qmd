...
<h4> Linh Ngo, supervised by Dianne Cook, Damjan Vukcevic </h4>
...
## Compare and constrast a large number of preference sets
...
[Thank you!]{style="font-size: 3em; font-weight: bold; display: block; margin-top: 1.5em;"}

:::

::: {.column width="45%"}

![](images/prefviz-sticker.png){width="90%"}
